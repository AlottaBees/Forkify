...
import dots from 'url:../../img/dots.svg';
import fracty from 'fracty';

class RecipeView extends View {
    // all views will have this in common
    ...
    _generateMarkup() {
        return `
            ...
            <div class="recipe__dots">
            <button class="btn--dots btn--menu ${this._data.key ? '' : 'hidden'}">
                <svg class="">
                <use href="${dots}#dots"></use>
                </svg>
            </button>
            </div>
            </div>
